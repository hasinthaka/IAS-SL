	...
	<?php
		...
		dynamic_sidebar( 'event_footer_options' );
			...
			<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
						<?php esc_html_e('Designed by:','event'); ?> <a title="<?php echo esc_attr__( 'Hasinthaka Eranga', 'event' ); ?>" target="_blank" href="<?php echo esc_url( 'https://www.facebook.com/hasinthaka.eranga' ); ?>"><?php esc_html_e('Hasinthaka Eranga','event');?></a>
					</div>
		<?php endif;?>
